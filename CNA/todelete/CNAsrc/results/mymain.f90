program main
    implicit none
    character(len=100), parameter :: xyz_infile = "Au55_chiral_min"! ".xyz "
    CHARACTER(LEN=100) :: INFILE, R_INFILE
...
!    real(8), parameter :: Bohr2Angstrom=0.52917721067D0 !0.529177249D0
    REAL(KIND=8), PARAMETER :: Bohr2Angstrom=0.52917721067D0
    ...
    LOGICAL, PARAMETER :: CONVERT_BOHR_TO_ANGSTROM = .FALSE. 
   WRITE(INFILE, "(A,A )") ADJUSTL(TRIM(xyz_infile)), ".xyz" 
   WRITE(R_INFILE, "(A,A)") ADJUSTL(TRIM(XYZ_INFILE)), ".r"
...
!   WRITE(MYUNIT1, *) 55
   OPEN(NEWUNIT=MYUNIT2 , FILE=ADJUSTL(TRIM(infile)), ACTION="READ", STATUS="OLD")
   READ(MYUNIT2, *) RCRD
   READ(MYUNIT2, *)
!   print*, "record = ", RCRD
   IF(CONVERT_BOHR_TO_ANGSTROM) THEN
   	DO I=1, NATOMS
   ...
   ELSE
	DO I=1, NATOMS
		READ(MYUNIT2, *) RCRD, COORDS(3*I-2:3*I)
		WRITE(MYUNIT1, "(3F22.16)") COORDS(3*I-2:3*I)
		WRITE(MYUNIT1, "(3F22.16)") 0.0, 0.0, 0.0
 		WRITE(MYUNIT1, "(I1)") 1
	ENDDO
   ENDIF
